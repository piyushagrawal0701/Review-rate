...
const Home = () => {
  ...
  const fetchCompanies = async (customFilters = null) => {
    try {
      setLoading(true);
    ...
    <div className="min-h-screen bg-[#f7f8fc]">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex flex-col xl:flex-row xl:items-end xl:justify-between gap-6">
          ...
          <div>
            <label className="block text-[#666] text-sm mb-2">Sort By</label>
        ...
        <div className="flex justify-between items-center mb-6">
          <p className="text-gray-500">
            Results Found:{" "}
            <span className="font-semibold text-black">{companies.length}</span>
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-3xl p-12 text-center shadow-sm">
            <h3 className="text-2xl font-semibold">No Companies Found</h3>
